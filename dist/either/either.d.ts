 ...
 */
declare class LeftImpl<L extends NonUndefined, R extends NonUndefined> implements Either<L, R> {
 ...
 */
declare class RightImpl<L extends NonUndefined, R extends NonUndefined> implements Either<L, R> {
    private readonly val;
    constructor(val: R);
    get type(): symbol;
    isLeft(): boolean;
 ...
 */
export declare function Left<L extends NonUndefined, R extends NonUndefined = never>(val: L): Either<L, R>;
/**
 * Factory function for creating a Right instance of Either.
 */
export declare function Right<R extends NonUndefined, L extends NonUndefined = never>(val: R): Either<L, R>;
/**
 * Type guard for checking if an Either is a Left.
 */
export declare function isLeft<L extends NonUndefined, R extends NonUndefined>(val: Either<L, R>): val is LeftImpl<L, R>;
/**
 * Type guard for checking if an Either is a Right.
 */
export declare function isRight<L extends NonUndefined, R extends NonUndefined>(val: Either<L, R>): val is RightImpl<L, R>;
export {};
