 ...
 * ```
 */
export declare function Ok<T extends NonUndefined, E extends NonUndefined = never>(val: T): OkResult<T, E>;
/**
 ...
 * ```
 */
export declare function Err<T extends NonUndefined, E extends NonUndefined>(val: E): ErrResult<T, E>;
/**
 ...
 * ```
 */
export declare function isOk<T extends NonUndefined, E extends NonUndefined>(val: Result<T, E>): val is OkResult<T, never>;
/**
 ...
 * ```
 */
export declare function isErr<T extends NonUndefined, E extends NonUndefined>(val: Result<T, E>): val is ErrResult<never, E>;
export {};
