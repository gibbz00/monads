 ...
 * ```
 */
export declare function Ok<T extends NonUndefined, E extends NonUndefined = never>(val: T): Result<T, E>;
/**
 ...
 * ```
 */
export declare function Err<T extends NonUndefined, E extends NonUndefined>(val: E): Result<T, E>;
/**
